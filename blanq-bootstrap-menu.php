...
Description: Plug-in component for the <a href="https://github.com/da-n/blanq">Blanq</a> WordPress theme. Extends the built-in Walker class to better integrate with the Twitter Bootstrap Framework navbar.
Version: 1.0
...
function blanq_bootstrap_nav( $args=array() ) {
  ...
  if ( $settings['theme_location'] ) {
    ...
    if ( $settings['container'] === true ) {
      echo '<div class="' . $settings['container_class'] . '"><div class="navbar-inner"><div class="container">';
